...
:------:|:------:|:------:|:------:|:------:|
syn-replicated-fp16-1gpus-inference | alexnet-768 | 100 | 50 | 9738.37 |
syn-replicated-fp16-1gpus-inference | inception3-96 | 100 | 50 | 817.767 |
syn-replicated-fp16-1gpus-inference | inception4-24 | 100 | 50 | 534.9 |
syn-replicated-fp16-1gpus-inference | resnet152-64 | 100 | 50 | 832.967 |
syn-replicated-fp16-1gpus-inference | resnet50-96 | 100 | 50 | 2208.97 |
syn-replicated-fp16-1gpus-inference | vgg16-96 | 100 | 50 | 724.4 |
syn-replicated-fp16-1gpus | alexnet-768 | 100 | 50 | 3865.85 |
syn-replicated-fp16-1gpus | inception3-96 | 100 | 50 | 268.167 |
syn-replicated-fp16-1gpus | inception4-24 | 100 | 50 | 122.7 |
syn-replicated-fp16-1gpus | resnet152-64 | 100 | 50 | 176.267 |
syn-replicated-fp16-1gpus | resnet50-96 | 100 | 50 | 523.45 |
syn-replicated-fp16-1gpus | vgg16-96 | 100 | 50 | 83.9667 |
syn-replicated-fp32-1gpus-inference | alexnet-384 | 100 | 50 | 6708.28 |
syn-replicated-fp32-1gpus-inference | inception3-48 | 100 | 50 | 533.5 |
syn-replicated-fp32-1gpus-inference | inception4-12 | 100 | 50 | 177.383 |
syn-replicated-fp32-1gpus-inference | resnet152-24 | 100 | 50 | 291.8 |
syn-replicated-fp32-1gpus-inference | resnet50-48 | 100 | 50 | 771.4 |
syn-replicated-fp32-1gpus-inference | vgg16-48 | 100 | 50 | 338.233 |
syn-replicated-fp32-1gpus | alexnet-384 | 100 | 50 | 2550.37 |
syn-replicated-fp32-1gpus | inception3-48 | 100 | 50 | 136.683 |
syn-replicated-fp32-1gpus | inception4-12 | 100 | 50 | 44.0667 |
syn-replicated-fp32-1gpus | resnet152-24 | 100 | 50 | 70.1333 |
syn-replicated-fp32-1gpus | resnet50-48 | 100 | 50 | 216.733 |
syn-replicated-fp32-1gpus | vgg16-48 | 100 | 50 | -nan |
syn-replicated-fp16-1gpus-inference | alexnet-768 | 130 | 50 | 11459.9 |
syn-replicated-fp16-1gpus-inference | inception3-96 | 130 | 50 | 948.067 |
syn-replicated-fp16-1gpus-inference | inception4-24 | 130 | 50 | 600.783 |
syn-replicated-fp16-1gpus-inference | resnet152-64 | 130 | 50 | 927.25 |
syn-replicated-fp16-1gpus-inference | resnet50-96 | 130 | 50 | 2478.52 |
syn-replicated-fp16-1gpus-inference | vgg16-96 | 130 | 50 | 843.617 |
syn-replicated-fp16-1gpus | alexnet-768 | 130 | 50 | 4345.13 |
syn-replicated-fp16-1gpus | inception3-96 | 130 | 50 | 306.9 |
syn-replicated-fp16-1gpus | inception4-24 | 130 | 50 | 137.583 |
syn-replicated-fp16-1gpus | resnet152-64 | 130 | 50 | 196.4 |
syn-replicated-fp16-1gpus | resnet50-96 | 130 | 50 | 578.25 |
syn-replicated-fp16-1gpus | vgg16-96 | 130 | 50 | 93.1 |
syn-replicated-fp32-1gpus-inference | alexnet-384 | 130 | 50 | 9219.45 |
syn-replicated-fp32-1gpus-inference | inception3-48 | 130 | 50 | 639.033 |
syn-replicated-fp32-1gpus-inference | inception4-12 | 130 | 50 | 225.85 |
syn-replicated-fp32-1gpus-inference | resnet152-24 | 130 | 50 | 328.017 |
syn-replicated-fp32-1gpus-inference | resnet50-48 | 130 | 50 | 973.7 |
syn-replicated-fp32-1gpus-inference | vgg16-48 | 130 | 50 | 344.617 |
syn-replicated-fp32-1gpus | alexnet-384 | 130 | 50 | 3208.05 |
syn-replicated-fp32-1gpus | inception3-48 | 130 | 50 | 172.417 |
syn-replicated-fp32-1gpus | inception4-12 | 130 | 50 | 52.6833 |
syn-replicated-fp32-1gpus | resnet152-24 | 130 | 50 | 79.2833 |
syn-replicated-fp32-1gpus | resnet50-48 | 130 | 50 | 253.583 |
syn-replicated-fp32-1gpus | vgg16-48 | 130 | 50 | -nan |
...
syn-replicated-fp32-1gpus-inference | vgg16-48 | 220 | 50 | 713.467 |
